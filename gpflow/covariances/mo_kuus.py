...
@Kuu_dispatcher.register(SharedIndependentMof, (SeparateIndependentMok, SeparateMixedMok))
...
@Kuu_dispatcher.register(SeparateIndependentMof, (SeparateIndependentMok, SeparateMixedMok))
